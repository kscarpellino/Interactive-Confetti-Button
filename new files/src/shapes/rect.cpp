...
float Rect::getRight() const       { return pos.x + (size.x / 2); } // Complete getRight
float Rect::getTop() const         { return pos.y + (size.y / 2); } // Complete getTop
float Rect::getBottom() const      { return pos.y - (size.y / 2); } // Complete getBottom
